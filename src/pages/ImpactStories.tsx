  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-32 bg-face-blue">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d')] bg-cover bg-center opacity-20"></div>
        <div className="relative container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <Award className="h-16 w-16 text-face-gold mx-auto mb-6" />
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4 text-white">Impact Stories</h1>
            <p className="text-xl text-gray-200">
              Inspirational journeys and remarkable achievements of those making a difference across the globe.
            </p>
          </div>
        </div>
      </section>
                ...
                {filteredStories.map((story) => (
                  <Card key={story.id} className="overflow-hidden card-hover border-none shadow-md">
                    <div className="relative h-48">
                      ...
                      <div className="absolute top-4 right-4">
                        <Badge className="bg-face-blue text-white">
                          {story.type === "video" ? "Video" : story.type === "interview" ? "Interview" : "Article"}
                        </Badge>
                      </div>
                    </div>
                    ...
                    <CardContent className="pt-6">
                      ...
                      <p className="text-gray-600 text-sm mb-1">Featuring: {story.nominee}</p>
